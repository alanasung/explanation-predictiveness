...
def _registered_builder(name: str):
    ...
    try:
        module = importlib.import_module("simulate.data")
...
def main(argv: list[str] | None = None) -> int:
    ...
    from simulate.utils.run_manifest import utc_now_iso, write_json_atomic
    ...
    if builder is not None:
        ...
        source = f"simulate.data.BUILDERS[{data.name!r}]"
        ...
        print(
            ...
            "src/simulate/data/__init__.py under BUILDERS, or use data=synthetic "
