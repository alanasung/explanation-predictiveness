...
from simulate.configs.loader import register_schema
...
def _load_stage_registry(package: str = "simulate") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in simulate.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from simulate.configs.loader import config_to_dict, save_resolved_config
    from simulate.models.device import get_device
    from simulate.utils.logging import configure_logging
    from simulate.utils.reproducibility import set_seed
    from simulate.utils.run_manifest import create_run_dir, save_run_metadata
